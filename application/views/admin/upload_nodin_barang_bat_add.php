  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-success">
       <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>Admin/action_upload_nodin_barang_bat_add" enctype="multipart/form-data">
        ...
        <div class="box-footer">
                    <div class="pull-center">
                        ...
                        <a href="<?php echo base_url(); ?>Admin/upload_nodin_barang_bat_view" class="btn btn-danger">Kembali</a>
