 									...
 									<tr>
 										...
 										<td>
 											...
 											<div class="hidden-sm hidden-xs action-buttons">
 												...
 												<a class="green" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/upload_nodin_konsultan_add?id_dokumen=" . $data['id_dokumen']."&id_users=" .$data['id_users'] ?>">
