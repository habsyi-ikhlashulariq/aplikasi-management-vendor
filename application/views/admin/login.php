...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>public/assets/dist/css/AdminLTE.css">
  
  
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/assets/custom_background.css">
  <!-- iCheck -->
...
<div class="login-box">
  <div class="login-logo">
     <img src="<?php echo base_url(); ?>public/images/Logo_PLN.png" height="140" width="90"> </a>
  </div>
  <!-- /.login-logo -->
