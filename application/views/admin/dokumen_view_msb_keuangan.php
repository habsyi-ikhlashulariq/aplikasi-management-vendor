 									...
 									<tr>
										...
										<td>
 										...
 										<td>
											 ...
											 ['tgl_komentar_direksi_pekerjaan'])); ?>
 										</td>
										<td>
										...
										//	$keterlambatan= date_diff($tgl_dateline, $tgl_sekarang);
											...
											if ($keterlambatan > 0) {
												echo $data['alasan_keterlambatan_msb_keuangan'];
											}else{
												echo "Belum Telat";
											}
 										...
 										<input type="hidden" name="id_dokumen" value="<?php echo $data['id_dokumen']; ?>">
											...
											$keterlambatan= $tgl_dateline->diff($tgl_sekarang)->format("%d");
												...
												?>
 												...
 												<a class="green" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/alasan_keterlambatan_msb_keuangan?id_dokumen=" . $data['id_dokumen'] ?>">
												 ...
												 ?>
													<a class="green" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/dokumen_verifikasi_msb_keuangan?id_dokumen=" . $data['id_dokumen'] ?>">
