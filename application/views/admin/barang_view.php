 									...
 									<tr>
 										...
 										<td>
 											...
 											<div class="hidden-sm hidden-xs action-buttons">
 												...
 												<a class="red" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/barang_delete?id_dokumen=" . $data['id_dokumen'] ?>" onclick="return confirm('Anda Yakin Menghapus Data Ini?');">
