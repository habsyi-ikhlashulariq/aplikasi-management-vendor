 							...
 							<tbody>
 								<?php foreach ($dokumen_view->result_array() as $data) { ?>
 									...
 									<tr>
										...
										<td>
 											<?php echo $data['isi_komentar_staff_bat']; ?>
 										</td>
										...
										<td>
 										...
 										<td>
 											<?php echo $data['tgl_komentar_msb_bat']; ?>
 										</td>
										<td>
										...
										//	$keterlambatan= date_diff($tgl_dateline, $tgl_sekarang);
											...
											if ($keterlambatan > 0) {
												echo $data['alasan_keterlambatan_direksi_pekerjaan'];
											}else{
												echo "Belum Telat";
											}
 										...
 										<td>
											...
											$keterlambatan= $tgl_dateline->diff($tgl_sekarang)->format("%d");
												...
												?>
 												...
 												<a class="green" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/alasan_keterlambatan_direksi_pekerjaan?id_dokumen=" . $data['id_dokumen'] ?>">
												 ...
												 ?>
													<a class="green" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/dokumen_verifikasi_direksi_pekerjaan?id_dokumen=" . $data['id_dokumen'] ?>">
