										 ...
										 <input type="hidden" name="id_dokumen" value="<?php echo $data['id_dokumen']; ?>">
											...
											$keterlambatan= $tgl_dateline->diff($tgl_sekarang)->format("%d");
												...
												?>
 												...
 												<a class="green" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/alasan_keterlambatan_staff_bat?id_dokumen=" . $data['id_dokumen'] ?>">
												 ...
												 ?>
													<a class="green" value="<?php echo $data['id_dokumen']; ?>" href="<?php echo base_url() . "Admin/dokumen_verifikasi_staff_bat?id_dokumen=" . $data['id_dokumen'] ?>">
