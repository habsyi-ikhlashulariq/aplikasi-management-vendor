      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
		   ...
		   <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_dokumen_verifikasi_msb_keuangan?id_dokumen=<?php echo $dokumennya['id_dokumen']; ?>" enctype="multipart/form-data">
            ...
            <div class="box-body">
				 ...
				 <input type="hidden" name="nama_dokumen" value="<?php echo $dokumennya['nama_dokumen']; ?>">
						...
						<br><br><br>
						      ...
						      <div class="col-lg-10">
						        	<div class="form-group">
                                <label for="isi_komentar_msb_keuangan" class="col-sm-3 control-label">Komentar</label>
                                <div class="col-sm-5">
<textarea class="form-control" id="isi_komentar_msb_keuangan" name="isi_komentar_msb_keuangan" aria-label="Komentar"></textarea>                          
							  </div>
                            </div>
                   </div>
						<br><br><br>
