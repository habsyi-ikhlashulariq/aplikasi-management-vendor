...
<head>
  ...
  <title>Aplikasi Management Vendor</title>
  ...
  <!-- SWEET ALERT -->
<link rel="stylesheet" href="<?php echo base_url(); ?>public/sweetalert2/dist/sweetalert2.css">
<script src="<?php echo base_url(); ?>public/sweetalert2/dist/sweetalert2.min.js"></script>
  <!-- // SWEET ALERT -->
  <!-- TIMELINE -->
<link rel="stylesheet" href="<?php echo base_url(); ?>public/assets/dist/css/Timeline.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets2/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets2/DataTables/DataTables-1.10.18/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets2/DataTables/Buttons-1.5.6/css/buttons.bootstrap4.min.css"> 
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>A</b>MV</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">AMV</span>
    </a>
